...
Removed the stale original design doc (`design/Ourbreak.md`) and its 10 MB source PDF,
...
- `design/Ourbreak.md` was a one-off PDF→markdown conversion (see the 2026-06-10
  ...
  Deleted.
- `design/Ourbreak.pdf` (≈10 MB) was the original PDF the stale `.md` came from — same
