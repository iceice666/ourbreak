...
Scene environment defines the minimal gameplay ground — a horizontal floor with a grid at the block base level — that gives the player a spatial reference instead of floating blocks. Placeholder visuals only; real environment/block art is M8.
