# Shell Splitting Spec

## Purpose

Shell defends itself by multiplying. Destroyed by the wrong weapon (Sword or Drone) it splits into more Shells instead of dying, so mindlessly AoE-bombing a Shell wall snowballs and burns the survival clock; the Gun is the clean answer. There is no player health.
